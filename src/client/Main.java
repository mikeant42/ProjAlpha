...
public class Main  {
    ...
    static class UI {
        HashMap<Integer, CharacterPacket> characters = new HashMap();
        ...
        public void removeCharacter (int id) {
            CharacterPacket character = characters.remove(id);
